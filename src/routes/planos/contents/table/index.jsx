  ...
  return (
    ...
    <thead>
        <tr>
          ...
          <th>Essencial</th>
          <th className="destaque">Estratégico
      ...
      <tbody>
        ...
        <tr>
          <td>Armazenamento</td>
          <td>15 GB</td>
          <td className="destaque">30 GB</td>
          <td>50 GB</td>
          <td>120 GB</td>
          <td>200 GB</td>
        </tr>
        ...
        <tr>
          ...
          <td className="destaque"><i class="fa-solid fa-circle-check"></i></td>
          <td><i class="fa-solid fa-circle-check"></i></td>
          <td><i class="fa-solid fa-circle-check"></i></td>
          <td><i class="fa-solid fa-circle-check"></i></td>
        </tr>
        ...
        <tr>
          ...
          <td><i class="fa-solid fa-x"></i></td>
          <td className="destaque"><i class="fa-solid fa-x"></i></td>
          <td><i class="fa-solid fa-circle-check"></i></td>
          <td><i class="fa-solid fa-circle-check"></i></td>
          <td><i class="fa-solid fa-circle-check"></i></td>
        </tr>
        ...
        <tr>
          ...
          <td className="destaque"><div className='price'><del>R$ 150,00</del> <span>R$ 119,99</span></div></td>
        ...
        <tr>
          ...
          <td className="destaque"><div className='price'><del>R$ 1.800,00</del> <span>R$ 1.199,99</span></div></td>
