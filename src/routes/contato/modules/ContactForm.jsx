...
export function ContactForm({ form, errors, handleChange, handleSubmit }) {
  return (
    <section className="contact-form-container">
      ...
      >
        ...
        {/* Email */}
        <div className={`input-group ${errors.email ? "invalid" : "valid"}`}>
        ...
        {/* Assunto */}
        <div className={`input-group ${errors.subject ? "invalid" : "valid"}`}>
        ...
        {/* Mensagem */}
        <div className={`input-group ${errors.message ? "invalid" : "valid"}`}>
